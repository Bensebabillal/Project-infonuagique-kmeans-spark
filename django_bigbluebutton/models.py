...
class Meeting(models.Model):
    ...
    def create_join_link(self, fullname, role='moderator', email=None, **kwargs):
        ...
        subject = 'Korrix Invitation: ' + meeting.name,
        html_message = render_to_string('mail/joinLink.html', {'name': fullname, 'link': link})
        plain_message = strip_tags(html_message)
        from_email = 'From <no-reply@korrix.com>'
        to = email
    ...
    @classmethod
    def create(cls, author, name, meeting_id, **kwargs):
        kwargs.update({
