<template>
  <vx-card no-shadow>
    ...
    <div class="flex flex-wrap justify-between items-center mb-8">
      <div>
        <p>Account is You already have an accounted with Google.</p>
        <p class="font-medium mb-4">john@gmail.com</p>
      </div>
      <vs-button type="border" color="danger">DisYou already have an account</vs-button>
    </div>

    <div class="flex flex-wrap justify-between items-center mb-base">
      <div>
        <p>Account is You already have an accounted with facebook.</p>
